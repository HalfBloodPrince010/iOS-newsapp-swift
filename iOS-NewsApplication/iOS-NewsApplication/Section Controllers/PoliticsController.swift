...
class PoliticsController: UIViewController, IndicatorInfoProvider, NewsModelDelegate, UIContextMenuInteractionDelegate {
        ...
        func handleBookmark(cell:UITableViewCell){
            ...
            if isThere == false{
                if var write_bookmark = UserDefaults.standard.array(forKey: "Bookmarks") as Array?{
                    ...
                    print("Bool False 1")
                    print(bookmark_data!)
                    let ucell = worldTableView.cellForRow(at: newsClicked!) as! PoliticsSectionCell
    ...
    @objc func refreshPage(refreshControl: UIRefreshControl) {
        print("Hello World!politics")
        self.newsData.getSectionHeadlines(section: "politics")
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let bookmark = UIAction(title: "Bookmark", image: UIImage(systemName: "bookmark")) { _ in
            let ucell = self.worldTableView.cellForRow(at: cellRow) as! PoliticsSectionCell
     ...
     extension PoliticsController : UITableViewDataSource, UITableViewDelegate{
         ...
         func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
             ...
             let cell = tableView.dequeueReusableCell(withIdentifier: "psectioncell") as! PoliticsSectionCell
