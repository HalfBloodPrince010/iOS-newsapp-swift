...
class BusinessController: UIViewController, IndicatorInfoProvider, NewsModelDelegate,UIContextMenuInteractionDelegate {
        ...
        func handleBookmark(cell:UITableViewCell){
            ...
            if isThere == false{
                if var write_bookmark = UserDefaults.standard.array(forKey: "Bookmarks") as Array?{
                    ...
                    print("Bool False 1")
                    print(bookmark_data!)
                    let ucell = worldTableView.cellForRow(at: newsClicked!) as! BusinessSectionCell
    ...
    @objc func refreshPage(refreshControl: UIRefreshControl) {
        print("Hello World!business")
        self.newsData.getSectionHeadlines(section: "business")
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let bookmark = UIAction(title: "Bookmark", image: UIImage(systemName: "bookmark")) { _ in
            let ucell = self.worldTableView.cellForRow(at: cellRow) as! BusinessSectionCell
     ...
     extension BusinessController : UITableViewDataSource, UITableViewDelegate{
         ...
         func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
             ...
             let cell = tableView.dequeueReusableCell(withIdentifier: "bsectioncell") as! BusinessSectionCell
