...
class SportsController: UIViewController, IndicatorInfoProvider,NewsModelDelegate, UIContextMenuInteractionDelegate {
   @IBOutlet weak var worldTableView: UITableView!
        ...
        func handleBookmark(cell:UITableViewCell){
            ...
            if isThere == false{
                if var write_bookmark = UserDefaults.standard.array(forKey: "Bookmarks") as Array?{
                    ...
                    print("Bool False 1")
                    print(bookmark_data!)
                    let ucell = worldTableView.cellForRow(at: newsClicked!) as! SportsSectionCell
    ...
    @objc func refreshPage(refreshControl: UIRefreshControl) {
        print("Hello World!sport")
        self.newsData.getSectionHeadlines(section: "sport")
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let bookmark = UIAction(title: "Bookmark", image: UIImage(systemName: "bookmark")) { _ in
            let ucell = self.worldTableView.cellForRow(at: cellRow) as! SportsSectionCell
    ...
    extension SportsController : UITableViewDataSource, UITableViewDelegate{
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "spsectioncell") as! SportsSectionCell
